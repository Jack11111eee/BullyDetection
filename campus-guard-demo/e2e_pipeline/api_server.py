...
def parse_args():
    ...
    p.add_argument('--yolo-pose', default='models/yolo11m-pose.pt')
    p.add_argument('--small-obj-model', default=None)
    p.add_argument('--falling-model', default='models/best-falling.pt')
    p.add_argument('--smoking-model', default='models/best-smoke.pt')
    p.add_argument('--phone-model', default='models/best-phone.pt')
